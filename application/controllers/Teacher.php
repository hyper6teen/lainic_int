...
{    
    ...
    public function view_profile()
    {
        ...
        $page_data['user_id'] = $this->session->userdata('teacher_id');
        $page_data['user_type'] = $this->session->userdata('login_type');

        $teacher_info1 = $this->db->get_where('teacher' , array(
            'teacher_id' => $page_data['user_id']
        ))->result_array();
        ...
        foreach ($teacher_info2 as $row) 
        {
            ...
            '<div style="width: 100%;">
                    <div class="prof-head2">ADDITIONAL INFORMATION</div>
                        <div style="background-color: #d4f208;  width: 100%;    height: .5%; margin-bottom: 55px;"></div>
                            <div style="width: 100%;    padding: .5%;">
                                <div class="prof-content"><span>SKYPE ID : </span>' . $row['skype_id'] . '</div>
                                ...
                                <div class="prof-content"><span>LAST SCHOOL ATTENDED : </span>' . str_replace('_', ' ', $row['last_school']) . '</div>
                                <div class="prof-content"><span>WORK EXPERIENCE : </span>' . str_replace('_', ' ', $row['work_exp']) . '</div>
